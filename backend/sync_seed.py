...
realistic_data = [
    ...
    {"region": ["달성군", "현풍읍", "테크노폴리스"], "name": "미래차 밧데리(주)", "insight": "해외 수출 물량 200% 증가. 생산직 50명 대규모 공채 및 공장 2동 증축 착공."}
]

print("Syncing Seed Data to Google Drive...")
...
for item in realistic_data:
    ...
    print(f"Uploaded: {'/'.join(path_list)}")
