...
create_file("backend/app/api/endpoints/__init__.py", "")
create_file("backend/app/services/__init__.py", "")
create_file("backend/app/core/__init__.py", "")

google_drive_content = """import os
import json
...
hierarchy_content = """from fastapi import APIRouter, HTTPException, Depends
...
dashboard_content = """from fastapi import APIRouter, HTTPException, Depends
from app.core.engine import engine
from sqlalchemy.orm import Session
from app.core.database import get_db, DataEntry
...
ingest_content = """from fastapi import APIRouter, HTTPException, UploadFile, File, Form, Depends
from sqlalchemy.orm import Session
from app.core.database import get_db, DataEntry
from app.core.engine import engine
...
chat_content = """from fastapi import APIRouter, HTTPException
from pydantic import BaseModel
from app.core.engine import engine
from app.services.gemini_ai import model
...
agora_content = """from fastapi import APIRouter, Depends, HTTPException
from sqlalchemy.orm import Session
from app.core.database import get_db, DataEntry
import random
...
admin_content = """from fastapi import APIRouter, Depends, Form, HTTPException
from sqlalchemy.orm import Session
from app.core.database import get_db, DataEntry
from app.core.engine import engine
from app.core.websocket import manager
...
create_file("backend/app/services/google_drive.py", google_drive_content)
create_file("backend/app/services/gemini_ai.py", gemini_ai_content)
create_file("backend/app/core/websocket.py", websocket_content)
create_file("backend/app/api/endpoints/hierarchy.py", hierarchy_content)
create_file("backend/app/api/endpoints/dashboard.py", dashboard_content)
create_file("backend/app/api/endpoints/ingest.py", ingest_content)
create_file("backend/app/api/endpoints/chat.py", chat_content)
create_file("backend/app/api/endpoints/agora.py", agora_content)
create_file("backend/app/api/endpoints/admin.py", admin_content)
